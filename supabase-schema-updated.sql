-- TyphoonFincon Database Schema - Updated for Current Form Structure
...
-- Create customer_applications table (matching your current form)
...
-- Create connector_registrations table (matching your current form)
